...
export function HomePage() {
  ...
  const demoUrl = "https://demo.theplannersassistant.uk";
              ...
              <div className="mt-8">
                  {isDesktop ? (
                    <div className="flex flex-wrap items-center gap-4">
                      <a href={demoUrl} target="_blank" rel="noopener noreferrer" className="px-5 py-3 rounded-2xl bg-[var(--color-accent)] text-white font-medium shadow-md hover:shadow-lg focus:outline-none focus:[box-shadow:var(--ring)] transition-shadow">Demo</a>
                    ...
                    <div className="w-full space-y-4">
                        <a href={demoUrl} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center w-full px-5 py-3 rounded-2xl bg-[var(--color-accent)] text-white font-medium shadow-md hover:shadow-lg focus:outline-none focus:[box-shadow:var(--ring)] transition-shadow">Launch demo</a>
                        ...
                        <p className="text-sm text-[var(--color-muted)] text-center">Built for desktop browsers. Use the hosted demo to explore the tools.</p>
                        <MobileInfoSection />
                    </div>
                  )}
              </div>
