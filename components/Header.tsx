    ...
    <header className={`sticky top-0 z-40 bg-[var(--color-panel)]/80 backdrop-blur border-b border-[var(--color-edge)] transition-shadow duration-300 ${scrolled ? 'shadow-sm' : ''}`}>
      <nav className="max-w-[1180px] mx-auto px-6 py-3 flex items-center gap-6">
        ...
        <div className="ml-auto flex items-center gap-2">
            ...
            <a
              href="https://demo.theplannersassistant.uk"
              target="_blank"
              rel="noopener noreferrer"
              className="hidden md:inline-flex items-center justify-center px-3 py-1.5 rounded-xl bg-[var(--color-accent)] text-white shadow-md hover:shadow-lg transition-shadow focus:outline-none focus:[box-shadow:var(--ring)]"
            >
              Demo
            </a>
        </div>
